Monthly Water Budget Models for Lake Superior
-------------------------------------------------------------------------
 
## Develop Monthly Multiple Regression and AR(1) Multiple Regression Equations
...
# 
```
2 Develop Multiple Regression Equation
```{r}
#
...
```
3 Plot Matrix of Monthly Measured and MultReg Estimated Flows at St. Marys River
```{r, fig.height=11}
#
...
#
```
4 Plot Monthly Parameter Estimates and Uncertainties for MultReg Model
```{r, fig.height=6}
...
```
5. Develop Monthly AR[1] Multiple Regression Model
```{r}
...
#
```
6 Plot Relation between Measured and AR[1] Multiple Regression Model Estimates
```{r, fig.height=11}
# Setup 4x3 plot frame for monthly data
par(mfrow=c(4,3),cex.lab=0.7,cex.main=0.9)
...
#
```
7 Plot Parameter Estimates and 95% Confidence Limits for AR[1] Regression Model
...
#
```
8 Plot R2 for Seasonal and Annual Multiple Regression Equations
