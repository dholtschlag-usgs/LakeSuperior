...
for (i in 1:12){
  ...
  plot(stmrCMSmon$DateSeq,stmrCMSmon$dStoCMS,
...
# Plot the trend in monthly Change in Storage for the minimum AIC
...
plot(stmrCMSmon$DateSeq,seq(1,63),type="n",
     ...
     xlab="Year",
     main="Monthly Trends in Changes in Storage of Lake Superior")
